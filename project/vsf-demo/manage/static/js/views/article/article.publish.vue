    ...
    <div class="container">
        <el-form class="form-box article"  label-width="80px">
                ...
                <el-upload
                  ...
                  :on-error="uploadError">
                    ...
                    <div class="el-upload__tip" slot="tip">
                        <div class="el-upload__text">将文件拖到虚框，或点击虚框上传。 <el-checkbox v-model="picture.used">是否设为常用</el-checkbox></div>
                    </div>
                </el-upload>
            </el-form-item>
            ...
            <el-form-item label="正文:">
                ...
                <quill-editor v-model="article.content" v-else
                      ref="myQuillEditor">
                </quill-editor>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    cacheInfo() {
      ...
      CommFunc.setSessionStorage("__CACHE_ARTICLE_PUBLUISH", this.article);
    },
    getCacheInfo() {
      if (!this.article.id) {
        let article = CommFunc.getSessionStorage("__CACHE_ARTICLE_PUBLUISH");
