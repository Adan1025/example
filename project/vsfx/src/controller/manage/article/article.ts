...
export class ArticleController {
     ...
     */
    @Post('/findAll')
    async findAllArticle({ body, session }, res) {
        ...
        res.sendSuccess(await articleService.findAllArticle({ usersId, articleTypeId, nickName, type, desabled, pageSize, currPage }));
    }
